...
function renderRecommendedNewsGrid() {
  ...
  container.innerHTML = `
    ...
    <div class="anandabazar-lead-card" onclick="openArticleModal('${leadItem.id || 'art-105'}')" style="background:var(--bg-card); cursor:pointer;">
      <div class="anandabazar-lead-thumb" style="height:250px;">
        <img src="${leadItem.image || 'epaper_pages/Bongodhwani 13-09-26-digital version_page-0005.jpg'}" alt="${leadItem.title || 'বিশেষ খবর'}" loading="lazy" />
      </div>
      ...
      ${sideItems.map(item => `
        <div class="anandabazar-side-item" onclick="openArticleModal('${item.id || 'art-101'}')" style="cursor:pointer;">
          <div class="anandabazar-side-thumb">
            <img src="${item.image || 'epaper_pages/Bongodhwani 13-09-26-digital version_page-0001.jpg'}" alt="${item.title || 'সংবাদ'}" loading="lazy" />
          </div>
...
function renderSectionGrid(categoryKey, containerId, districtFilter = "all") {
  ...
  if (!sideList || sideList.length === 0) {
    sideList = [
      { id: "art-related-1", title: "এই সম্পর্কিত আরও বিস্তারিত ও গুরুত্বপূর্ণ খবরের আপডেট", categoryBengali: "সম্পর্কিত খবর", image: "epaper_pages/Bongodhwani 13-09-26-digital version_page-0003.jpg", epaperPage: 3, date: "আজ" },
      { id: "art-related-2", title: "আঞ্চলিক পরিস্থিতির ওপর বিশেষ প্রতিবেদন ও বিশ্লেষণ", categoryBengali: "বিশেষ প্রতিবেদন", image: "epaper_pages/Bongodhwani 13-09-26-digital version_page-0016.jpg", epaperPage: 16, date: "আজ" },
      { id: "art-related-3", title: "অন্যান্য জেলার নির্বাচিত গুরুত্বপূর্ণ সংবাদ সংক্ষেপ", categoryBengali: "অন্যান্য সংবাদ", image: "epaper_pages/Bongodhwani 13-09-26-digital version_page-0001.jpg", epaperPage: 1, date: "আজ" }
    ];
  }
  ...
  gridContainer.innerHTML = `
    ...
    <div class="anandabazar-lead-card" onclick="openArticleModal('${leadArticle.id || 'art-102'}')">
      <div class="anandabazar-lead-thumb">
        <img src="${leadArticle.image || 'epaper_pages/Bongodhwani 13-09-26-digital version_page-0002.jpg'}" alt="${leadArticle.title || 'সংবাদ'}" loading="lazy" />
      </div>
    ...
    <div class="anandabazar-side-stack">
      ${sideList.map(item => `
        <div class="anandabazar-side-item" onclick="openArticleModal('${item.id || 'art-102'}')">
          <div class="anandabazar-side-thumb">
            <img src="${item.image || 'epaper_pages/Bongodhwani 13-09-26-digital version_page-0002.jpg'}" alt="${item.title || 'সংবাদ'}" loading="lazy" />
          </div>
          <div>
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
              <span class="badge badge-navy" style="font-size:0.65rem;">${item.categoryBengali || 'সংবাদ'}</span>
...
const categoryNameMap = {
  ...
  "desh": "দেশ ও রাজনীতি",
  "bharat": "সনাতনী নারী",
  "neighbour": "বিদেশ বিভুঁই",
  "history": "ইতিহাস ও বিতর্ক",
  "opinion": "সম্পাদকীয় ও দৃষ্টি"
};
...
const categoryTitleMap = {
  ...
  "desh": "দেশ ও রাজনীতি সংবাদ (পৃষ্ঠা ৪ ও ৫)",
  "neighbour": "বিদেশ বিভুঁই ও আন্তর্জাতিক সংবাদ (পৃষ্ঠা ৬, ৭, ১১, ১২)",
  "opinion": "সম্পাদক দর্পণ ও আপনার দৃষ্টি (পৃষ্ঠা ৮ ও ১৬)",
  "history": "ইতিহাস, কৃষ্টি ও বিতর্ক-বিমর্শ (পৃষ্ঠা ৯, ১০, ১৫)",
  "bharat": "সনাতনী নারী ও সমাজচিন্তন (পৃষ্ঠা ১৩ ও ১৪)"
};
  ...
  heroContainer.innerHTML = `
    ...
    <div class="anandabazar-lead-card" onclick="openArticleModal('${hero.id || 'art-101'}')" style="background:var(--bg-card); cursor:pointer;">
      <div class="anandabazar-lead-thumb" style="height:310px;">
        <img src="${hero.image || 'epaper_pages/Bongodhwani 13-09-26-digital version_page-0001.jpg'}" alt="${hero.title || 'প্রধান সংবাদ'}" loading="lazy" />
      </div>
      <div style="display:flex; justify-content:space-between; align-items:center; margin-top:8px;">
  ...
  container.innerHTML = sortedByViews.slice(0, 5).map((article, idx) => `
    <div class="trending-item-nextlevel" onclick="openArticleModal('${article.id || 'art-101'}')">
      ...
      <div class="trending-thumb">
        <img src="${article.image || 'epaper_pages/Bongodhwani 13-09-26-digital version_page-0001.jpg'}" alt="${article.title || 'সংবাদ'}" loading="lazy" />
      </div>
